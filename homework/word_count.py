...
def create_ouptput_directory(output_directory):
    ...
    if os.path.exists(output_directory): 
        # Itera sobre los archivos que se están leyendo con blob
        for file in glob.glob(f"{output_directory}/*"):
            os.remove(file) # borrado fisico
        os.rmdir(output_directory)
        # luego si borro la carpeta madre (ciclo: no se puede borrar si tiene archivos dentro)
